...
class SppagebuilderAddonTestimonialcarousel extends SppagebuilderAddons {
    ...
    public function render() {
        ...
        $output .= '<div class="sppb-carousel-list">';
	...
	public function scripts() {
		return array(JURI::base(true) . '/templates/tz_new_age/js/TweenMax.min.js');
	}
	...
	public function js() {
		...
		jQuery(function($){
			$(document).ready(function(){
				startAnim($(\''.$addon_id.' .sppb-slider-item\').toArray(), \''.$addon_id.'\', \''.$interval.'\');
			});
		})';
