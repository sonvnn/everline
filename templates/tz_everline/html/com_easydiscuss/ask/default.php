...
if (JComponentHelper::isInstalled('com_tz_envato_license')) {
    ?>
    <div class="alert alert-success" role="alert">
        <p>This forum is private. The discussion will only be visible by the creator and the moderator of the category</p>
        <strong>PLEASE PROVIDE INFORMATION:</strong>
        <ul>
            <li>Your issue detail</li>
            <li>Current site url</li>
            <li>Product in use and version</li>
            <li>Admin login to your website</li>
        </ul>
    </div>
    <?php
}
