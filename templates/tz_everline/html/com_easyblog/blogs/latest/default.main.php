...
?>
<div class="eb-post card" data-blog-posts-item data-id="<?php echo $post->id;?>">
	...
	<?php } ?>
	<div class="eb-post-content card-body">
		<?php echo $this->output('site/blogs/admin.tools', array('post' => $post, 'return' => $return)); ?>

		<?php if (($this->config->get('layout_avatar') && $this->params->get('post_author_avatar', true)) || $this->params->get('post_date', true) || $this->params->get('post_author', true) || $this->params->get('post_category', true) || $post->isFeatured || $post->isFavourited()) { ?>
