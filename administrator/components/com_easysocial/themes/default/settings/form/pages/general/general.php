...
<div class="row">
	...
	<div class="col-md-6">
		<div class="panel">
			<?php echo $this->html('panel.heading', 'COM_ES_SETTINGS_GIPHY'); ?>

			<div class="panel-body">
				<?php echo $this->html('settings.toggle', 'giphy.enabled', 'COM_ES_SETTINGS_GIPHY_ENABLED'); ?>

				<div class="form-group">
					<?php echo $this->html('panel.label', 'COM_ES_SETTINGS_GIPHY_API_KEY'); ?>
				...
				<div class="form-group">
						<?php echo $this->html('panel.label', 'COM_ES_SETTINGS_GIPHY_ITEMS_LIMIT'); ?>

						<div class="col-md-7">
							<?php echo $this->html('grid.inputbox', 'giphy.limit', $this->config->get('giphy.limit'), 'giphy.limit', array('class' => 'input-short text-center')); ?>
						</div>
					</div>
			</div>
		</div>
